...
namespace APIClub.Migrations
{
    ...
    [Migration("20260603182850_RefactorizarModuloViajes")]
    partial class RefactorizarModuloViajes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIClub.Domain.Auth.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$RZb.Qa3jBHj9Rcu3d2b1OO1V89nUz4nSQh4MUvGq7ANNe6GuTb1UC",
                            Rol = 1
                        });
                });
