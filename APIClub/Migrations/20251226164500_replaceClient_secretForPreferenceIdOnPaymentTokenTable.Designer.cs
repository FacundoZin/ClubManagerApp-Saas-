...
namespace APIClub.Migrations
{
    ...
    [Migration("20251226164500_replaceClient_secretForPreferenceIdOnPaymentTokenTable")]
    partial class replaceClient_secretForPreferenceIdOnPaymentTokenTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIClub.Domain.PaymentsOnline.Modelos.PaymentToken", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaExpiracion = new DateOnly(2026, 1, 25),
                            IdSocio = 1,
                            anio = 2025,
                            monto = 2500.00m,
