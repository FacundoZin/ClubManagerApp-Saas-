...
namespace APIClub.Migrations
{
    ...
    [Migration("20260617034914_AddEditViajes")]
    partial class AddEditViajes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIClub.Domain.Auth.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$x7NRaxkTgH7batkORsKtaeIzvyEr1hfsrn1tgo9DUvmvKwJXaDjKu",
                            Rol = 1
                        });
                });
            ...
            modelBuilder.Entity("APIClub.Domain.ModuloGestionViajes.Models.PagoInscriptoViaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("InscriptoViajeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("InscriptoViajeId");

                    b.ToTable("PagosInscriptosViaje");
                });

            modelBuilder.Entity("APIClub.Domain.ModuloGestionViajes.Models.PagoInscriptoViajeAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PagosInscriptosViajeAudit", (string)null);
                });
            ...
            modelBuilder.Entity("APIClub.Domain.ModuloGestionViajes.Models.PagoInscriptoViaje", b =>
                {
                    b.HasOne("APIClub.Domain.ModuloGestionViajes.Models.InscriptoViaje", null)
                        .WithMany("HistorialPagos")
                        .HasForeignKey("InscriptoViajeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("APIClub.Domain.ModuloGestionViajes.Models.PagoInscriptoViajeAudit", b =>
                {
                    b.HasOne("APIClub.Domain.ModuloGestionViajes.Models.InscriptoViaje", "InscriptoViaje")
                        .WithMany("HistorialModificaciones")
                        .HasForeignKey("InscriptoViajeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InscriptoViaje");
                });
            ...
            modelBuilder.Entity("APIClub.Domain.ModuloGestionViajes.Models.InscriptoViaje", b =>
                {
                    b.Navigation("HistorialModificaciones");
