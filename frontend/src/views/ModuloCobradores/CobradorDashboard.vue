      ...
      <div v-if="activeTab === 'buscar-socios'">
        ...
        <div v-else-if="socios.length > 0">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <CobradorSocioCard v-for="socio in socios" :key="socio.id" :socio="socio" @pay="handlePago"
      ...
      <div v-if="activeTab === 'crear-lote'">
        <div class="max-w-2xl mx-auto">
          <div class="bg-white p-8 rounded-xl border border-slate-200 shadow-sm text-center">
            ...
            <button @click="isLoteModalOpen = true"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-4 min-h-[600px]">
            ...
            <div class="lg:col-span-1 border-r border-slate-100 bg-slate-50/30 flex flex-col">
              ...
              <div class="flex-1 overflow-y-auto p-4 space-y-2">
                ...
                <template v-else>
                  <button v-for="cobrador in cobradores" :key="cobrador.idCobrador" @click="selectCobrador(cobrador)"
                    :class="[
            ...
            <div class="lg:col-span-3 flex flex-col bg-white">
              ...
              <div v-else class="flex flex-col h-full">
                ...
                <div
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-3 mt-1">
                      <span class="text-xs font-semibold px-2 py-0.5 bg-teal-100 text-teal-700 rounded-md">Total
                        recaudado</span>
                ...
                <div class="flex-1 overflow-x-auto">
                  <div v-if="loadingHistorial" class="p-12 flex flex-col items-center border-b border-slate-50">
                      ...
                      <tbody class="divide-y divide-slate-50">
                        <tr v-for="(cobro, idx) in historialData.cobrosRealizados" :key="idx"
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-right">
                            <span class="text-sm font-bold text-teal-600 bg-teal-50 px-3 py-1 rounded-lg">
