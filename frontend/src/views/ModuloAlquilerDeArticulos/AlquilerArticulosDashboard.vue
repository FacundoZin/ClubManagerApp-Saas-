    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-6 overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 no-scrollbar">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          <div>
            <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">Ortopedia y Alquileres</h2>
      ...
      <div v-if="activeTab === 'articulos'">
        <!-- Botón Nuevo Artículo (visible solo en mobile) -->
        <div class="mb-6 sm:hidden">
          <button @click="isArticuloModalOpen = true"
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div
                ...
                <div class="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-center sm:text-left">
