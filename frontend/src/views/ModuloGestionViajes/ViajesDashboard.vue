...
<template>
  <div class="min-h-screen bg-slate-50 font-sans text-slate-800">
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        <button
          ...
          :class="[
            action.hoverBorder,
            currentAction === action.id ? 'ring-2 ring-teal-500 border-transparent' : '',
          ]"
        >
          <div
          ...
          <div class="relative z-10 mt-auto">
            <h3
              class="text-lg font-bold text-slate-900 mb-1 group-hover:text-teal-700 transition-colors duration-300"
            >
              {{ action.title }}
            </h3>
      ...
      >
        ...
        <!-- LIST ACTION -->
        <div v-else-if="currentAction === 'list'">
          ...
          <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <ViajeCard
              ...
              :key="viaje.id"
              :viaje="viaje"
              :is-expanded="expandedViajeId === viaje.id"
              :variantes="expandedViajeVariantes"
              :is-loading-variantes="isLoadingVariantes"
              @toggle-variantes="toggleVariantes(viaje.id)"
              @create-variante="openCreateVariante(viaje.id)"
              @view="viewDetail(viaje.id)"
            />
          </div>
        </div>

        <!-- INSCRIBIR ACTION (Step-by-step) -->
        <div v-else-if="currentAction === 'inscribir'" class="max-w-3xl mx-auto py-4">
          ...
          <div class="mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-200">
            ...
            <div class="flex gap-3">
              ...
              <button
                ...
                :disabled="isSearchingSocio || !searchDni"
                class="px-6 py-3 bg-blue-600 text-white font-bold rounded-xl shadow-lg hover:bg-blue-700 transition-all disabled:opacity-50"
              >
                Buscar
              </button>
            </div>
            ...
            >
              <div
                class="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 mr-4"
              >
              ...
              <button
                @click="resetInscriptionFlow"
                class="ml-auto p-2 text-slate-400 hover:text-red-500"
              >
          ...
          >
            <div
              v-if="selectedSocio"
              class="mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-200"
            >
              <h4 class="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4">
    ...
    <InscripcionConfirmModal
      ...
      :socio="selectedSocio"
      :id-viaje="selectedViajeId"
      @close="isInscripcionModalOpen = false"
      @save="handleFinishInscripcion"
    />
