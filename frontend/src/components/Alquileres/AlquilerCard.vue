...
<template>
  <div
    class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow relative"
  >
    ...
    <div class="space-y-2.5 mb-6">
      ...
      <div class="flex items-center text-sm text-slate-600">
        ...
        <span class="font-medium">Iniciado el:</span>
        <span class="ml-1">{{ alquiler.fechaAlquiler }}</span>
      </div>
      ...
      <div class="flex items-center text-sm text-slate-600">
        ...
        <span class="ml-1">{{ alquiler.dniSocio }}</span>
      </div>
      ...
      <div v-if="alquiler.direccionSocio" class="flex items-start text-sm text-slate-600">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4 mr-2 mt-0.5 text-slate-400"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <div v-if="alquiler.telefonoSocio" class="flex items-center text-sm text-slate-600">
        ...
        <span>{{ alquiler.telefonoSocio }}</span>
      </div>
    </div>
    ...
    <div class="pt-4 border-t border-slate-100">
      <button
        ...
        class="w-full inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors"
      >
