        ...
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 border-b border-slate-100">
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <h3 class="text-lg font-semibold leading-6 text-slate-900" id="modal-title">Registrar Nueva Reserva</h3>
              <div class="mt-2">
                <p class="text-sm text-slate-500">Complete los datos para agendar una nueva reserva de salón.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="number" id="importe" v-model="form.importe" step="0.01" min="0"
                ...
                <div>
                    <label for="totalPagado" class="block text-sm font-medium text-slate-700">Monto Abonado</label>
                     <div class="relative mt-1 rounded-md shadow-sm">
                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                            <span class="text-slate-500 sm:text-sm">$</span>
                        </div>
                        <input type="number" id="totalPagado" v-model="form.totalPagado" step="0.01" min="0"
                            class="block w-full rounded-md border-slate-300 pl-7 pr-3 focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 border">
                    </div>
                </div>
            </div>
