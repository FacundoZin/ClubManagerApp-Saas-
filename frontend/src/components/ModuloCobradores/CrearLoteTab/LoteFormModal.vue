      ...
      <div
        ...
        <form @submit.prevent="handleSubmit">
          <div class="px-4 py-5 sm:p-6 space-y-4">
            ...
            <div>
              <label for="nombreLote" class="block text-sm font-medium text-slate-700">Nombre del Lote *</label>
              <input type="text" id="nombreLote" v-model="form.nombreLote" required
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label for="calleNorte" class="block text-xs font-medium text-slate-600">Calle Norte</label>
                  <input type="text" id="calleNorte" v-model="form.calleNorte"
                    class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm px-3 py-2 border"
                    placeholder="Nombre de calle" />
                </div>
                <div>
                  <label for="calleSur" class="block text-xs font-medium text-slate-600">Calle Sur</label>
                  <input type="text" id="calleSur" v-model="form.calleSur"
                    class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm px-3 py-2 border"
                    placeholder="Nombre de calle" />
                </div>
                <div>
                  <label for="calleEste" class="block text-xs font-medium text-slate-600">Calle Este</label>
                  <input type="text" id="calleEste" v-model="form.calleEste"
                    class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm px-3 py-2 border"
                    placeholder="Nombre de calle" />
                </div>
                <div>
                  <label for="calleOeste" class="block text-xs font-medium text-slate-600">Calle Oeste</label>
                  <input type="text" id="calleOeste" v-model="form.calleOeste"
                    class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm px-3 py-2 border"
                    placeholder="Nombre de calle" />
                </div>
              </div>
