        ...
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 border-b border-slate-100">
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-slate-500">Complete la información para dar de alta un nuevo socio en el sistema.
                </p>
              </div>
            </div>
          </div>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="px-4 py-5 sm:p-6 space-y-4">
            ...
            <div>
              ...
              <input type="text" id="direccion" v-model="form.direcccion"
                class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 border">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" id="lote" v-model="form.lote"
                  class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 border">
              </div>
              <div>
